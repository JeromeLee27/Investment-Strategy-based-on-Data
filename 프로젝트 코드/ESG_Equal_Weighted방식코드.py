...
#accumulate된 변수들을 바탕으로 수익률 dataframe을 만들어준다.
...
FactorReg['ESG_MKT'] = FactorReg['ESG_win'] - FactorReg['MKF2000']
...
#FactorReg['ESG_MKT'] = FactorReg['win_lose'] - FactorReg['MKF2000'] 에서 이용한 걸 그대로 사용
